...
<html lang="en">
    ...
    <body>
        <main class="font-poppins">
            ...
            {{--| CONTENT |--}}
            <section
                class="w-[90%] mx-auto flex justify-center items-center flex-col my-10"
            >
                <h2
                    class="font-poppins text-black text-3xl font-normal text-center mb-5"
                >
                    We Buy Your Gold and Platinum
                </h2>
                <p
                    class="font-poppins text-gray-600 text-base font-normal mb-10 text-center"
                >
                    Trust a Jewelery Store with Over 70 years of experience and
                    an
                    <span class="font-bold text-black"
                        >A+ Rating with the Better Business Bureau</span
                    >
                    to give you superior value.
                </p>
                <img
                    src="{{ url('/images/download (4).webp') }}"
                    class="mb-10"
                    alt=""
                />
                <h3
                    class="font-poppins text-black text-xl font-normal text-center mb-5"
                >
                    Why Should You Choose Topper?
                </h3>
                <p
                    class="font-poppins text-gray-600 text-base font-normal mb-5 text-center"
                >
            ...
            <section class="w-[90%] mx-auto lg:w-[1024px]">
                ...
                <div class="w-full mb-5">
                    <!-- Question -->
                    <div
                        class="bg-gray-100 flex justify-between items-center h-[60px] px-3 faqQuetion"
                    >
                        <div
                            class="font-poppins font-semibold text-xl text-black"
                        >
                    ...
                    <div class="w-full mt-3 mb-10 faqAnswers hidden">
                        ...
                        <a
                            class="font-poppins text-black text-base font-semibold underline mb-10 text-center"
                            href="{{
                                url(
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="w-full mt-3 mb-10 faqAnswers hidden">
                        ...
                        <div
                            class="md:flex md:justify-between md:items-center md:w-[600px] md:mx-auto"
                        >
                            <ul>
                                <li
                ...
                <div class="w-full mb-5">
                    ...
                    <div class="w-full mt-3 mb-10 faqAnswers hidden">
                        ...
                        <a
                            class="font-poppins text-black text-base font-semibold underline mb-10 text-center"
                            href="#"
                            >Click Here for our Details and Declaration of
